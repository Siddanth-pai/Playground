...
INSTALLED_APPS = [
    'streamIT.apps.StreamitConfig',#newly added by me
    ...
    #'streamIT',
    'users.apps.UsersConfig',# newly added
    'crispy_forms',# newly addded by me that is it is an an third party django app installed by me
]
